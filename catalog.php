            ...
            <div class="col-lg-9 section-divided__main section-divided__main-left">
              <div class="section-sm">
                ...
                <div class="row justify-content-sm-center row-70">
                  ...
                  <div class="col-md-6 col-xl-4">
                    <div class="product product-grid">
                      <div class="product-img-wrap"><img src="images/italian-Moes Telecomture-contemporary-allumen-fixed-or-extendable-glass-top-table-by-sedit-2-300x300.jpg" alt="" width="300" height="300"/>
                        <div class="product-icon-wrap"><span class="icon icon-md linear-icon-heart" data-toggle="tooltip" data-original-title="Add to Wishlist"></span><span class="icon icon-md linear-icon-balance" data-toggle="tooltip" data-original-title="Add to Compare"></span></div>
                      ...
                      <div class="product-caption">
                        ...
                        <h6 class="product-title"><a href="single-product.html">Italian Moes Telecomture contemporary allumen GLASS TABLE</a></h6>
                  ...
                  <div class="col-md-6 col-xl-4">
                    <div class="product product-grid">
                      <div class="product-img-wrap"><img src="images/italian-Moes Telecomture-contemporary-mix-steel-base-wooden-table-top-dining-table-by-sedit-2-300x300.jpg" alt="" width="300" height="300"/>
                        <div class="product-icon-wrap"><span class="icon icon-md linear-icon-heart" data-toggle="tooltip" data-original-title="Add to Wishlist"></span><span class="icon icon-md linear-icon-balance" data-toggle="tooltip" data-original-title="Add to Compare"></span></div>
                      ...
                      <div class="product-caption">
                        ...
                        <h6 class="product-title"><a href="single-product.html">Italian Moes Telecomture contemporary mix steel base WOODEN SET</a></h6>
